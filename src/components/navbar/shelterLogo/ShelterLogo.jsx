...
const ShelterLogo = ({ toggleShelter }) => {
  ...
  return (
    <div className="container-logo-shelter" onClick={toggleShelter}>
      <svg
        className="shelter"
        width="95"
        height="96"
      ...
      <div className="counter">
        <span className="counter-animals">{animalCounter}</span>
      </div>
    </div>
  );
};

export default ShelterLogo;
